...
# Load data
# =========================
folder_path = Path(r"C:\Users\kade\OneDrive\سطح المكتب\rfp_intelligence_system\RFP-20260531T140504Z-3-001\RFP")
...
for file_path in folder_path.rglob("*"):
    ...
    if file_path.suffix.lower() not in [".pdf", ".docx", ".xlsx"]:
        continue
